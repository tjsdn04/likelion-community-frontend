      ...
      <Button>
        <Link to="/main">
          <Icon
            ...
            alt="home icon"
            $isClick={clickedIndex === 1} // $를 추가하여 transient prop으로 설정
      ...
      <Button>
        <Link to="/commuMain">
          <Icon
            ...
            alt="board icon"
            $isClick={clickedIndex === 2} // $를 추가하여 transient prop으로 설정
      ...
      <Button>
        <Link to="/chatList">
          <Icon
            ...
            alt="chat icon"
            $isClick={clickedIndex === 3} // $를 추가하여 transient prop으로 설정
      ...
      <Button>
        <Link to="/school">
          <Icon
            ...
            alt="school icon"
            $isClick={clickedIndex === 4} // $를 추가하여 transient prop으로 설정
...
const Icon = styled.img`
  width: 24px;
  height: 24px;
  /* $isClick prop을 사용하여 스타일 설정 */
  filter: ${({ $isClick }) =>
    $isClick ? "grayscale(0%)" : "grayscale(100%)"};
`;
